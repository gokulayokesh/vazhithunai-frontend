...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/hashtagacademy/Desktop/wd/Vazhithunai/vazhithunai-frontend/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/hashtagacademy/Desktop/wd/Vazhithunai/vazhithunai-frontend/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'generated::a1sZrsZjwYUZvtQF','home','generated::z7WgED8d7jjlTQ3f','generated::mE9pXrszo7RJ5Stl','generated::oxE3Ebs0Mxw9xWdE',
'register.store','generated::Km51Ci0zTifulpQ5','generated::vbllh4dcKODI2uqx','listings.search','profile',
'login','logout','myaccount','profiles.search','shortlist.add',
'payment.initiate','payment.success','payment.callback','storage.local',);
        registerArgumentsSet('views', 
'emails.registration_otp','errors.401','errors.402','errors.403','errors.404',
'errors.419','errors.429','errors.500','errors.503','errors.layout',
'errors.minimal','include.footer','include.header','include.login','include.nav-header',
'include.script','layout.about','layout.account','layout.contact','layout.home',
'layout.listings','layout.privacy','layout.profile','layout.register','layout.terms',
'payment.success','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor',
...
'VITE_APP_NAME','PHONEPE_CLIENT_ID','PHONEPE_CLIENT_SECRET','PHONEPE_CLIENT_VERSION','PHONEPE_SALT_INDEX',
'PHONEPE_ENV',);
