...
class UserDetails extends Model
{
    protected $fillable = [
        ...
        'gender', 'height', 'color', 'caste', 'marital_status', 'city_id', 'address', 'body_type', 'physical_status', 'mother_tongue', 'interests', 'hobbies', 'favorite_cuisine', 'favorite_music', 'sports', 'pet_preference', 'travel_preference', 'diet_preference', 'smoking_habits', 'drinking_habits', 'languages_known', 'life_motto', 'email', 'mobile', 'facebook_profile_url', 'instagram_profile_url', 'twitter_profile_url',
