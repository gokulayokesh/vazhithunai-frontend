    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 80%;">
        <div class="modal-content border-0 shadow-lg rounded-3">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white fw-bold" id="termsModalLabel">Terms & Condition</h5>
                    ...
                    <div class="container" data-aos="fade-up">
                        ...
                        <div class="tos-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div id="agreement" class="content-section">
                                ...
                                <p>By registering on our website or using our services, you agree to comply with these
                                    Terms &
                                    Conditions. If you do not agree, please do not use our platform.</p>
                                <div class="info-box">
                                    <i class="bi bi-info-circle"></i>
                                    <p>These terms apply to all members, visitors, and anyone accessing our services.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div id="eligibility" class="content-section">
                                <h3>2. Eligibility</h3>
                                <p>You must be at least 18 years old (or the legal marriageable age in your
                                    jurisdiction) to
                                    register. By creating an account, you confirm that you are legally eligible to marry
                                    as per
                            ...
                            <div id="user-accounts" class="content-section">
                                ...
                                <div class="alert-box">
                                    ...
                                    <div class="alert-content">
                                        ...
                                        <p>You are responsible for safeguarding your login credentials and for all
                                            activities
                            ...
                            <div id="prohibited" class="content-section">
                                ...
                                <p>Members must use the platform only for genuine matrimonial purposes. The following
                                    activities
                            ...
                            <div id="privacy" class="content-section">
                                ...
                                <p>We respect your privacy. Personal information will be handled in accordance with our
                                    Privacy
                            ...
                            <div id="disclaimer" class="content-section">
                                <h3>6. Disclaimers</h3>
                                <p>We do not guarantee that you will find a suitable match. The platform is a
                                    facilitator and is
                            ...
                            <div id="limitation" class="content-section">
                                ...
                                <p>We are not liable for any direct, indirect, or consequential damages arising from
                                    your use of
                                    the platform, including but not limited to emotional distress, financial loss, or
                                    disputes
                                    between members.</p>
                            </div>
                            ...
                            <div id="termination" class="content-section">
                                <h3>9. Termination</h3>
                                <p>We reserve the right to suspend or terminate your account without prior notice if you
                                    breach
                            ...
                            <div id="governing-law" class="content-section">
                                ...
                                <p>These Terms are governed by the laws of India, and any disputes will be subject to
                                    the
