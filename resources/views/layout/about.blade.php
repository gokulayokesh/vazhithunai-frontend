                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            ...
                            <div class="hero-content text-center" data-aos="zoom-in" data-aos-delay="200">
                                ...
                                <p class="hero-description">Where Souls Connect, Love Grows. At Vazhithunai Matrimony, we
                                    believe that love is the foundation upon which beautiful unions are built, and destiny
                                    is the guiding force that brings two souls together.</p>
                            </div>
                                ...
                                <div class="row g-4 align-items-center">
                                    <div class="col-lg-6">
                                        <div class="primary-image-wrap">
                                            <img src="assets/img/homepage/img4.png" alt="Luxury Partner" class="img-fluid">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="secondary-image-wrap">
                                            <img src="assets/img/homepage/img3.png" alt="Professional Agent"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonial-card">
                                        ...
                                        <div class="testimonial-author">
                                            <div class="author-image">
                                                <img src="assets/img/homepage/img8.png" alt="Client" class="img-fluid">
                                            </div>
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-8">
                                ...
                                <div class="action-buttons">
                                    ...
                                    {{-- <a href="properties.html" class="btn btn-secondary">Browse Profiles</a> --}}
                                </div>
                            </div>
                        </div>
                    </div><!-- End CTA Section -->
